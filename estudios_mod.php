...
if(paso==3)
{
	...
	if( destinofondo == "HIJO")
	{
		...
		if(calcular_edad(fecha) > 23){
			$("#destino").tooltipster('content', "Hijo no puede tener mas de 23 años.");
			$("#destino").tooltipster("show");
			return false; 		
		}
	}
...
$(document).ready(function() {
 ...
 //maxDate: fecha tope D=días | M=mes | Y=año
	...
	$(".actionBar").append('<a href="files/INSTRUCCIONES%20PASO%20A%20PASO%20BES%20VP.pdf" target="_blank" class="pasoapaso" style="float: left;">PDF Paso a Paso</a>');
	...
	*/
	...
	$(".esconviviente").hide();
	 ...
	 <?php if($g[0]->TIPO_POSTULANTE=="HIJO"){ ?>
	 	$(".elegidodestino").html("Haz Selecionado destinar los fondos para: HIJO");
	 	$(".eshijo").show();
 	 <?php } ?>
	 <?php if($g[0]->TIPO_POSTULANTE=="CONYUGUE"){ ?>
	 	$(".elegidodestino").html("Haz Selecionado destinar los fondos para: CONYUGUE");
	 	$(".esconyugue").show();
 	 <?php } ?>
	 <?php if($g[0]->TIPO_POSTULANTE=="CONVIVIENTE"){ ?>
	 	$(".elegidodestino").html("Haz Selecionado destinar los fondos para: CONVIVIENTE");
	 	$(".esconviviente").show();
 	 <?php } ?>
	 <?php if($g[0]->TIPO_POSTULANTE=="TRABAJADOR"){ ?>
	 	$(".elegidodestino").html("Haz Selecionado destinar los fondos para: TRABAJADOR");
 	 <?php } ?>
	...
	$(".videopaso").click(function(){
		var iframe = $('<iframe frameborder="0" src="http://www.youtube.com/embed/3PIiJGgjtlQ" marginwidth="0" marginheight="0" height="350px" width="450px" allowfullscreen></iframe>');
...
<div id="wizard" class="wizard tabbedwizard" style="display:none;">
                        ...
                        <ul class="tabbedmenu anchor">
                            ...
                            <li>
                            	<a href="#wiz3step5" class="disabled" isdone="0" rel="5" >
                                    ...
                                    <span class="label">Documentacion</span>
                                </a>
                            </li>
                            <li>
                            	<a href="#wiz3step6" class="selected" isdone="1" rel="6"  >
                                	<span class="h2">FINALIZAR</span>
                                    <span class="label">Enviar la Postulacion</span>
                                </a>
                            </li>
                        </ul>
                    ...
                    <form id="paso1" class="stdform">
                        ...
                        <form id="paso5" class="stdform">
                        	...
                        	<h4>Paso 5: Requisito de Documentacion</h4>
                            
                            <p>
                                   <div class="alert-box notice"><span>NOTA: </span>El tamaño méximo de subida de los archivos son 15 MB c/u y Los archivos permitidos tiene extension: jpg,jpeg,doc,docx,pdf,tif. </div>
                             </p>
                             <div style="clear:both"></div>
                            <p>
                            ...
                            <p>
                                   <div style="float:left">
                                    <label class="files" style="width:200px;">Concentracion de Notas</label>
                      ...
                      <div class="par terms">
                                ...
                                <p>Una vez completados todos los datos requeridos, ya podrás postular al beneficio. <br><br> Pero antes se ejecutará un proceso de validación, donde los pasos con problemas serán marcados con un símbolo <img src="img/icon_alert.png" />. Haz click a continuación para revisar tu postulación.</p>
                                <p><div class="botonenviarpostulacion" style="float: left;">REVISAR TU POSTULACION</div></p>
                                <br><br />
                                <p><div class="aceptapostular" style="float: left; display:none;">ENVIAR MI INFORMACION</div></p>
                            </div>
                            </form>
                        </div>
